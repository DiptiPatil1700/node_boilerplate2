...
const { each, size, set, isEmpty, isObject, startCase, chain, map, get, has, isNumber, cloneDeep } = pkg;
// import crypto from "crypto";
// import appConst from "./appConstants";
import { paginateData1 } from "./appConstants.js";
...
*/
export const dataPagination = (paginateData = {}) => {

    let currentPage = (parseInt((paginateData.page || 0)) > 0) ? parseInt(paginateData.page) : 1;
    const pageSize = ((parseInt((paginateData.pageSize || 0)) > 0) && (parseInt((paginateData.pageSize || 0)) <= paginateData1.pageSizeLimit)) ? parseInt(paginateData.pageSize) : paginateData1.pageSize;
